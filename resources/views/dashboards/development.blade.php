...
<div id="dashboard">
    <dashboard class="font-sans">
        <twitter position="a1:a24" :initial-tweets="{{ json_encode($initialTweets) }}"></twitter>
        ...
        <gitlab-labels position="b1:c16" label="To Do" :show-time="false" :show-assignees="true" order-by="weight"></gitlab-labels>
        <gitlab-labels position="b17:c24" label="Bug patrol" :show-time="false" :show-assignees="true" order-by="weight"></gitlab-labels>
        <gitlab-labels position="d1:e24" label="Implementing solution" :show-time="false" order-by="weight" :show-assignees="true"></gitlab-labels>
